...
cleaned_data$`Free Lunch Eligible [Public School] 2022-23` <- as.numeric(cleaned_data$`Free Lunch Eligible [Public School] 2022-23`)
cleaned_data$`Black or African American Students [Public School] 2022-23` <- as.numeric(cleaned_data$`Black or African American Students [Public School] 2022-23`)
cleaned_data$`White Students [Public School] 2022-23` <- as.numeric(cleaned_data$`White Students [Public School] 2022-23`)
cleaned_data$`Hispanic Students [Public School] 2022-23` <- as.numeric(cleaned_data$`Hispanic Students [Public School] 2022-23`)
cleaned_data$`American Indian/Alaska Native Students [Public School] 2022-23` <- as.numeric(cleaned_data$`American Indian/Alaska Native Students [Public School] 2022-23`)
cleaned_data$`Asian or Asian/Pacific Islander [Public School] 2022-23` <- as.numeric(cleaned_data$`Asian or Asian/Pacific Islander Students [Public School] 2022-23`)
cleaned_data$`Nat. Hawaiian or Other Pacific Isl. Students [Public School] 2022-23` <- as.numeric(cleaned_data$`Nat. Hawaiian or Other Pacific Isl. Students [Public School] 2022-23`)
cleaned_data$`Two or More Races Students [Public School] 2022-23` <- as.numeric(cleaned_data$`Two or More Races Students [Public School] 2022-23`)
cleaned_data$`Total Race/Ethnicity [Public School] 2022-23` <- as.numeric(cleaned_data$`Total Race/Ethnicity [Public School] 2022-23`)

# Negative Binomial Regression

negative_binomial_model <- glm.nb(`Free Lunch Eligible [Public School] 2022-23` ~ `White Students [Public School] 2022-23` + `Black or African American Students [Public School] 2022-23` + `Hispanic Students [Public School] 2022-23` + `American Indian/Alaska Native Students [Public School] 2022-23` + `Asian or Asian/Pacific Islander [Public School] 2022-23` + `Nat. Hawaiian or Other Pacific Isl. Students [Public School] 2022-23` + `Two or More Races Students [Public School] 2022-23`, cleaned_data)
...
logistic_model <- glm(majority_free_lunch ~ minority_percentage, family = binomial(link = "logit"), cleaned_data)
...
minority_percentages <- cleaned_data |>
...
ggplot(cleaned_data, aes(x = minority_percentage, y = majority_free_lunch)) + geom_line(data = minority_percentages, aes(x = minority_percentage, y = predicted_probability)) + labs(x = "Percentage of Minorities at a School", y = "Predicted Probability") + theme_minimal()
